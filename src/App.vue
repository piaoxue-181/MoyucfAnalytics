  ...
  <section class="han_analytics">
    ...
    <main>
      <header>
        <Alert>
          <AlertDescription>
            <p>· Moyucf Analytics 是一个简单的网络分析跟踪器和仪表板，托管在被称为赛博菩萨的 Cloudflare 上,无成本稳定运行,每天可达10万次免费统计。</p>
            <p>· 域名、服务器、数据库 通通都不用! 托管在 Cloudflare Pages 上即可快速部署网站分析仪表板。</p>
            <p style="font-weight: bold;">· 开源地址: <a class="git-link" href="https://github.com/piaoxue-181/HanAnalytics"
                target="_blank">Moyucf-Analytics</a>
            </p>
          </AlertDescription>
        </Alert>
      </header>
    ...
    <footer>
      ...
      <p>
        ...
        <a href="https://api.blowswind.cn" target="_blank"><img src="./assets/svg/surppot.svg"></a>
      </p>
    </footer>
  </section>
...
const getIconUrl = (url: string) => {
  if (!url) return 'https://favicon.qqsuu.cn/none'
  const _url = new URL(url)
  return `https://favicon.qqsuu.cn/${_url.hostname}`
}
